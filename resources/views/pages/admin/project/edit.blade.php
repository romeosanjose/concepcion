...
<form>
  ...
  <div class="form-group">
    ...
    <input type="project_name" class="form-control" id="project_name" value="{{$project->project_name}}">
  </div>
  <div class="form-group">
    <label for="project_desc">enter project description: *</label>
    <textarea  class="form-control" id="project_desc">{{$project->project_desc}}</textarea>
  </div>
 <div class="checkbox">
      @if ($user->is_admin) 
  ...
  <button  class="btn btn-success" onclick="updateProject();">Update</button>
